                ...
                <div style={{ marginLeft: 20, marginRight: 20 }}>
                    ...
                    cart.map((item) => {
                      return (
                        <Typography
                          ...
                          key={item.itemId._id}
                        >
                          <div className={classes.spaceTypo} style={{color: "white"}} >
                  ...
                  {step === 1 && (
                    <Button
                      ...
                      disabled={price === 0}
                      onClick={nextStep}
                      style={{ backgroundColor: "#5cdb95", fontWeight: "bold", color: "white" }}
                    >
                      Proceed to Checkout
                    </Button>
                  )}
                  {step === 2 && (
                    <Button
                      ...
                      style={{ backgroundColor: "#5cdb95", fontWeight: "bold" }}
                    >
                      Place Order
                    </Button>
                  )}
